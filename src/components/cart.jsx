...
const Cart = ()=>{
    return <Sheet>
         <SheetTrigger classNames='group -m-2 flex items-center p-2'> 
            <ShoppingCart aria-hidden='true' classNames='h-6 w-6 flex-shrink-0 flex-gray-400 group-hover:text-gray-500'>
            </ShoppingCart> 
